 ...
 */
JNIEXPORT jint JNICALL Java_fcmaes_core_Jni_optimizeDA(JNIEnv *env, jclass cls,
        jobject func, jdoubleArray jlower, jdoubleArray jupper,
        jdoubleArray jinit, jint maxEvals, jint use_local_search, jlong seed,
        jint runid) {
    ...
    try {
        ...
        double bestY = minimize(&fitfun, enc, seed, use_local_search > 0, X);
