 ...
 */
JNIEXPORT jint JNICALL Java_fcmaes_core_Jni_optimizeLCLDE(JNIEnv *env,
        jclass cls, jobject func, jdoubleArray jlower, jdoubleArray jupper,
        jdoubleArray jinit, jdoubleArray jsigma, jint maxEvals,
        jdouble stopfitness, jint popsize, jdouble pbest, jdouble F0,
        jdouble CR0, jlong seed, jint runid) {
