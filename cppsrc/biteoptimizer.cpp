...
class BiteOptimizer : public CBiteOpt {

public:

	BiteOptimizer(long runid_, Fitness *fitfun_, int dim_, int seed_,
 ...
 */
JNIEXPORT jint JNICALL Java_utils_Jni_optimizeBite
  ...
  jint maxEvals, jdouble stopfitness, jint popsize, jlong seed, jint runid) {
	...
	BiteOptimizer opt(runid, &fitfun, dim, seed, popsize, maxEvals, stopfitness);
