...
public class Solo extends Fitness {
    ...
    static final int[][][] resos_ = new int[][][] { { { 1, 1 }, { 5, 4 }, { 4, 3 } }, { { 1, 1 }, { 5, 4 }, { 4, 3 } },
...
//            buf.append(sorted.get(y).prettyDetails() + "\n");
    ...
    public double eval(double[] x) {
        ...
        t += tof01;
        Resonance res1 = Resonance.resonance(venus, t, vout_in[1], resos_[0], beta[0], safe_distance, outs, dvs);
        ...
        for (int r = 1; r < resos.length; r++) {
            ...
            res = Resonance.resonance(venus, t, v_in, resos_[r], beta[r], safe_distance, outs, dvs);
