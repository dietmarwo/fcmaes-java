...
public class OptimizerActivityWorker {
  ...
  public static void main(String[] args) throws ExecutionException, InterruptedException {
    try {
        ...
        // Only one activity is running. Parallelism is implemented by the parallel optimization retry.
        WorkerOptions wo = WorkerOptions.newBuilder()
                .setMaxConcurrentActivityExecutionSize(1).build();
        Worker worker = factory.newWorker(OptimizerRetryWorker.TASK_QUEUE, wo);
